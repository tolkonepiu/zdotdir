...
# ZDOTDIR - Directory where Zsh looks for its configuration files (.zshrc, .zprofile, etc.)
export ZDOTDIR=${ZDOTDIR:-$XDG_CONFIG_HOME/zsh}

# ZSH_CACHE_DIR - Directory for storing Zsh-related cache files (e.g. completions)
